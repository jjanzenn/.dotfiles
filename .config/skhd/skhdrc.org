...
#+begin_src conf :tangle ~/.config/skhd/skhdrc :mkdirp yes
  cmd - d : ls /Applications/ /Applications/Utilities/ /System/Applications/ /System/Applications/Utilities/ ~/Applications/ | grep '\.app$' | sed 's/\.app$//g' | choose -f "SauceCodePro Nerd Font" -s 15 -b ece0c9 | xargs -I {} open -a "{}.app"
#+end_src
