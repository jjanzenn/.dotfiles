...
#+begin_src emacs-lisp
  ...
  (when (eq system-type 'darwin)
    (setenv "PKG_CONFIG_PATH" "$PKG_CONFIG_PATH:/opt/homebrew/lib/pkgconfig/:/opt/homebrew/:/opt/homebrew/opt/libffi/lib/pkgconfig/:/opt/homebrew/opt/poppler/lib/pkgconfig/"))
#+end_src
